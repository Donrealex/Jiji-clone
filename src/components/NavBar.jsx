    ...
    return (
        <section className='flex items-center bg-primary p-2 justify-between px-30 border-b-1 border-b-gray-500'>
            ...
            <div className='flex items-center gap-5'>
                <div className='relative group p-1.5 bg-white rounded-full cursor-pointer'><IoMdBookmark color='grey' size={25} />
                ...
                <div className='relative group p-1.5 bg-white rounded-full cursor-pointer'><MdMessage color='grey' size={25} />
                ...
                <div className='relative group p-1.5 bg-white rounded-full cursor-pointer'><IoNotifications color='grey' size={25} />
                ...
                <div className='relative group p-1.5 bg-white rounded-full cursor-pointer'><ImNewspaper color='grey' size={25} />
                ...
                <div className='relative group p-1.5 bg-gray-500 rounded-full border-1 border-white cursor-pointer'><FaUser color='white' size={25} />
                    <div className='absolute top-full left-0 -translate-x-1 mt-2 hidden cursor-pointer group-hover:flex group-hover:flex-col transition-all duration-1000 ease-in-out translate-y-1 group-hover:translate-y-0 bg-white rounded-md'>
                        <div className='flex items-center border-b-1 hover:bg-gray-200 border-b-gray-300 px-5 py-3 gap-2 whitespace-nowrap rounded-t-md'><div><LuShoppingBasket size={25} /></div>My shop</div>
                        <div className='flex items-center border-b-1 hover:bg-gray-200 border-b-gray-300 px-5 py-3 gap-3 whitespace-nowrap'><div><CgComment size={25} /></div>Feedback</div>
                        <div className='flex items-center border-b-1 hover:bg-gray-200 border-b-gray-300 px-5 py-3 gap-3 whitespace-nowrap'><div><RiBarChart2Fill size={25} /></div>Performance</div>
                        <div className='flex items-center border-b-1 hover:bg-gray-200 border-b-gray-300 px-5 py-3 gap-3 whitespace-nowrap'><div><IoMdSettings size={25}/></div>Settings</div>
                        <div className='flex items-center px-5 py-3  hover:bg-gray-200 gap-3 whitespace-nowrap rounded-b-md'><div><LuLogOut size={25} /></div>Log out</div>
                    </div>
                </div>
