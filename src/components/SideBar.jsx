...
import { propertyData, vehicleData, phoneData, electronicsData } from '../constant/data'
  ...
  return (
    <section className={`${style} font-jiji`}>
      ...
      <div className="absolute overflow-y-scroll top-10 h-120 left-30 flex flex-col bg-white rounded-lg transition-all duration-300">
        <div
          onMouseEnter={() => {
            setIsVehicleHovered(!isVehicleHovered);
          }}
          onMouseLeave={() => {
            setIsVehicleHovered(!isVehicleHovered);
          }}
        ...
        <div
          onMouseEnter={() => {
            setIsPropertyHovered(!isPropertyHovered);
          }}
          onMouseLeave={() => {
            setIsPropertyHovered(!isPropertyHovered);
          }}
        ...
        <div
          onMouseEnter={() => {
            setIsPhoneHovered(!isPhoneHovered);
          }}
          onMouseLeave={() => {
            setIsPhoneHovered(!isPhoneHovered);
          }}
        ...
        <div
          onMouseEnter={() => {
            setIsElectronicsHovered(!isElectronicsHovered);
          }}
          onMouseLeave={() => {
            setIsElectronicsHovered(!isElectronicsHovered);
          }}
