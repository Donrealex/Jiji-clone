...
const SideBar = ({ style }) => {
  ...
  return (
      <section className={`${style} font-jiji text-sm hidden lg:block`}>
        <div>
          {isVehicleHovered ? (
            <div
              onMouseEnter={() => {
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isVehicleHovered
          ...
          {isPropertyHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isPropertyHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isPhoneHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isPhoneHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isElectronicsHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isElectronicsHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isHomeHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isHomeHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isFashionHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isFashionHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isBeautyHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isBeautyHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isServiceHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isServiceHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isRepairHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isRepairHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isCommercialHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isCommercialHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isLeisureHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isLeisureHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isBabiesHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isBabiesHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isFoodHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isFoodHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isAnimalHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isAnimalHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isJobsHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isJobsHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
          ...
          {isSeekingworkHovered ? (
            <div
              ...
              className={`absolute top-5 h-120 z-40 left-95 rounded-lg overflow-y-scroll bg-white shadow-md transition-all duration-1000 ease-in ${isSeekingworkHovered
                ? "opacity-100 scale-100"
                : "opacity-0 scale-95 pointer-events-none"
                }`}
            >
