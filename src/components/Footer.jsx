...
const Footer = () => {
  ...
  return (
    <>
      {/* Laptop View */}
      <footer className="bg-primary hidden lg:block items-baseline justify-center text-white  pb-8 mt-auto font-jiji">
        {/* Cityscape image */}
      ...
      {/* Mobile View */}
      <footer className="flex flex-col lg:hidden font-jiji bg-primary text-white ">
        <div className="flex px-10 pt-3 pb-15 items-center justify-between">
          ...
          <div onClick={() => { setMobileFooter(!mobileFooter) }}>
            <IoIosArrowDown color="white" size={30} />
          </div>
        </div>
        {mobileFooter ? <div className="flex flex-col px-10 gap-7">
          ...
          <div className="text-center text-white text-sm mb-3">
            <p>Free Classified in Nigeria</p>
            &copy; {new Date().getFullYear()} Jiji.ng
          </div>
        </div> : ""}
      </footer>
